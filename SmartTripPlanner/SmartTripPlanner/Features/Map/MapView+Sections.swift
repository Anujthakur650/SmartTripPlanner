...
extension MapView {
    ...
    func placeDetailCard(for place: Place) -> some View {
        PlaceDetailCard(
            ...
            routeOrigin: $viewModel.routeOrigin,
            isRouting: viewModel.isRouting,
            onEdit: { editingPlace = place },
            onToggleBookmark: { viewModel.toggleBookmark(for: $0) },
            onOpenInMaps: viewModel.openSelectedPlaceInMaps,
            onUseCurrentLocation: viewModel.useCurrentLocationAsOrigin,
            onClearRouteOrigin: { viewModel.routeOrigin = nil },
            onRoute: viewModel.routeToSelectedPlace
        )
    }
