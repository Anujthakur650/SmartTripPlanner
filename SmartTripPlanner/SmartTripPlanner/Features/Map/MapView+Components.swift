...
private extension MapView {
    var mapHeader: some View {
        mapSection
            .frame(height: 320)
            .overlay(alignment: .top) { mapOverlay }
    }
    ...
    var mapSection: some View {
        ...
        .mapStyle(.standard)
        .onChange(of: mapSelection, perform: handleMapSelection(_:))
    }
    ...
    func handleMapSelection(_ newValue: Place.ID?) {
    ...
    func associationEditor(for place: Place) -> some View {
